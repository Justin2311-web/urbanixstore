...
function mapStoreSettings(row?: Database["public"]["Tables"]["store_settings"]["Row"] | null): StoreSettings {
  ...
  return {
    ...
    platformLogoUrls: {
      facebook: typeof (socialLinks as Record<string, unknown>).facebook_logo === "string" ? (socialLinks as Record<string, unknown>).facebook_logo as string : "",
      instagram: typeof (socialLinks as Record<string, unknown>).instagram_logo === "string" ? (socialLinks as Record<string, unknown>).instagram_logo as string : "",
      tiktok: typeof (socialLinks as Record<string, unknown>).tiktok_logo === "string" ? (socialLinks as Record<string, unknown>).tiktok_logo as string : "",
  ...
  const result = await supabase.from("store_settings").upsert(
    {
      ...
      social_links: {
        ...
        lazada: settings.platformLinks?.lazada ?? "",
        facebook_logo: settings.platformLogoUrls?.facebook ?? "",
        instagram_logo: settings.platformLogoUrls?.instagram ?? "",
        tiktok_logo: settings.platformLogoUrls?.tiktok ?? "",
        shopee_logo: settings.platformLogoUrls?.shopee ?? "",
        lazada_logo: settings.platformLogoUrls?.lazada ?? "",
      },
